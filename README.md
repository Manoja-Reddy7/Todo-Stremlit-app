This is a simple Todo application built using Streamlit and Python. The app allows users to add, edit, and delete tasks from a list, providing an intuitive interface for managing daily tasks.
